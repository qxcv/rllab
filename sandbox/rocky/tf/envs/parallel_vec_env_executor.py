...
class ParallelVecEnvExecutor(object):
    ...
    def map_envs(self, map_fn):
        # this file seems to do something almost identical to
        # parallel_sampler.py; IDK what this one is actually used for.
        raise NotImplementedError(
            "need to copy map_task from parallel_sampler to here")
